...
- [Overview](#overview)
- [General Affinity Farms](#general-affinity-farms)
- [Plains of Eidolon Stealth Farming](#plains-of-eidolon-stealth-farming)
- [Steel Path Elara](#steel-path-elara)
...
<figure class="guide-text-image__img" style="flex: 0 0 30%;">
  <img src="../../images/affinity-farming/affinity-range.webp" alt="Affinity-Symbols">
</figure>
</div>
...
1. Hop into archwing
2. Fly high up
3. Find a camp (If there are no enemies move closer, if they're moving move further up/away) 
4. **Wait 2-3 seconds once enemies freeze** (otherwise you can sometimes lose the multiplier)
5. Hop out of archwing (melee key) and aim to float in air
6. Shoot the enemies. Clear the first camp to stack up your stealth multiplier, then only kill Eximi units in the other camps
7. **After** the enemies die, hop back into Archwing and repeat steps 3-7 until maxed

</div>
<figure class="guide-text-image__img" style="flex: 0 0 40%;">
  <img src="../../images/affinity-farming/eido-path.webp" alt="Eido-Path">
</figure>
</div>
