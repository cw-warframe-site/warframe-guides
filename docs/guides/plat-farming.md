...
- [Overview](#overview)
- [Prime Parts / Prime Sets](#prime-parts-prime-sets)
- [Ayatan Sculptures](#ayatan-sculptures)
- [Nightmare Mods](#nightmare-mods)
- [Veiled Rivens](#veiled-rivens)
- [Syndicate Augments](#syndicate-augments)
- [Requiem Relics and Requiem Mods](#requiem-relics-and-requiem-mods)
...
There are several ways to obtain Ayatan sculptures including:
- Finding one hidden randomly in a mission (roughly a 1 in 7 spawn chance)
- Completing Maroo's Weekly Treasure Hunt mission
- Completing the daily Sortie (28% chance for an Anasa sculpture)
- Completing Arbitration missions
