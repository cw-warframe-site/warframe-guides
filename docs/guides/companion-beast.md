...
![Incubation Tab](../images/companion/incubation.webp){ .center .bordered .floored width=60% }
...
<figure class="guide-text-image__img" style="flex: 0 0 30%;">
  <img src="../../images/companion/den.webp" alt="Feral Kubrow Den">
</figure>
</div>
...
![Weakened Predasite](../images/companion/predasite.webp){ .center .bordered .floored width=60% }
