...
# Primes, Vaulting, & Resurgence

<div class="inline-toc" markdown="1">
<p class="inline-toc__title">Table of Contents</p>

- [Overview](#overview)
- [Vaulting Explained](#vaulting-explained)
- [Obtaining Vaulted Primes](#obtaining-vaulted-primes)
- [Farming Aya](#farming-aya)
- [Current Primes](#current-primes)
...
The primary way to obtain vaulted primes is through **Prime Resurgence**, run by Varzia, a former Dax soldier. You can find her in Maroo's Bazaar on Mars or through the Prime Resurgence tab in the in-game Market.

Varzia offers two things:

- **Vaulted relics and cosmetics** purchased with Aya, a farmable currency
- **Fully built Primes and Prime Accessories** purchased with Regal Aya, an untradeable premium currency

Two Prime Warframes rotate through her shop roughly every 30 days, and additional Primes may be added during special events.
...
There are two main approaches to farming Aya:

1. **Active farming** - Tier 5 Bounties at the Necralisk, Deimos or on Cetus, Earth have a good chance to give Aya.
2. **Passive farming** - Relic packs, which can be purchased from syndicates, can contain Aya instead of a relic.
