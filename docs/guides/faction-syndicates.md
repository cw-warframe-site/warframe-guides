...
![Syndicate Six](../images/faction-syndicates/syndi-six.webp){ .center .bordered .floored width=90% }
...
![Syndicate Relations Map](../images/faction-syndicates/syndicate-map.webp){ .center .bordered .floored width=60% }
...
<span style="font-size: 2em; font-weight: bold;">PERSONAL SATISFACTION</span>

<span style="font-size: 0.75em;">Just kidding!</span>
...
<figure class="guide-text-image__img" style="flex: 0 0 35%;">
  <img src="../../images/faction-syndicates/medallion.webp" alt="Medallion">
</figure>
</div>
